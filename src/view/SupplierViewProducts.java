 ...
 * @author 
 */
public class SupplierViewProducts extends javax.swing.JFrame {

    /**
     * Creates new form SupplierViewProducts
     */
    MainController controller;
    String selectedProduct;
    public SupplierViewProducts() {
        initComponents();
    }
    public SupplierViewProducts(MainController aThis) {
        this();
        controller = aThis;
    ...
    private void initComponents() {
        ...
        categoryView = new javax.swing.JMenuItem();
        ...
        jMenu4.add(addProduct);

        categoryView.setText("Add Category");
        categoryView.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                categoryViewActionPerformed(evt);
            }
        });
        jMenu4.add(categoryView);
       ...
       //Show the search type in the label
        ...
        switch (str){
            ...
            try {
                ...
                Logger.getLogger(SupplierViewProducts.class.getName()).log(Level.SEVERE, null, ex);
            }
            }
                break;
    ...
    private void categoryViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_categoryViewActionPerformed
        
        controller.addCategory();
    }//GEN-LAST:event_categoryViewActionPerformed

    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        controller.viewSupplierProfile();
    }//GEN-LAST:event_jMenuItem2ActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JMenuItem addProduct;
    private javax.swing.JMenuItem categoryView;
